...
MODELS_CONFIG = [
    {'name': 'EfficientNet-B3',   'save_path': 'model_efficientnet.pth',  'lr': 1e-3},
    {'name': 'ResNet-50',         'save_path': 'model_resnet50.pth',       'lr': 5e-4},
    {'name': 'MobileNetV3-Large', 'save_path': 'model_mobilenetv3.pth',    'lr': 1e-3},
]
